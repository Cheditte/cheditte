    ...
    <>
      ...
      <div className={styles.container}>
        ...
        <p className={styles.text}>
          ...
          pasajları da içeren Letraset yapraklarının yayınlanması ile ve yakın zamanda Aldus PageMaker
        ...
        <p className={styles.text}>
          ...
          <Link href="/cheditte"><a className={styles.btn}>See Cheditte List</a></Link>
      </div>
    </>
  )
}
